...
[docs]def piece_symbol(piece_type: PieceType) -> str:
    return typing.cast(str, PIECE_SYMBOLS[piece_type])


[docs]def piece_name(piece_type: PieceType) -> str:
...
[docs]class Termination(enum.Enum):
...
[docs]def parse_square(name: str) -> Square:
    """
...
[docs]def square_name(square: Square) -> str:
    """Gets the name of the square, like ``a3``."""
    return SQUARE_NAMES[square]


[docs]def square(file_index: int, rank_index: int) -> Square:
    """Gets a square number by file and rank index."""
    return rank_index * 8 + file_index


[docs]def square_file(square: Square) -> int:
    """Gets the file index of the square where ``0`` is the a-file."""
    return square & 7


[docs]def square_rank(square: Square) -> int:
    """Gets the rank index of the square where ``0`` is the first rank."""
    return square >> 3


[docs]def square_distance(a: Square, b: Square) -> int:
    """
...
[docs]def square_mirror(square: Square) -> Square:
...
[docs]    def unicode_symbol(self, *, invert_color: bool = False) -> str:
        """
...
[docs]@dataclasses.dataclass(unsafe_hash=True)
class Move:
    """
...
[docs]    def clear_board(self) -> None:
        """Clears the board."""
        self._clear_board()
...
[docs]    def pieces(self, piece_type: PieceType, color: Color) -> SquareSet:
        """
...
[docs]    def piece_at(self, square: Square) -> Optional[Piece]:
...
[docs]    def piece_type_at(self, square: Square) -> Optional[PieceType]:
...
[docs]    def color_at(self, square: Square) -> Optional[Color]:
...
[docs]    def king(self, color: Color) -> Optional[Square]:
        """
...
[docs]    def attacks(self, square: Square) -> SquareSet:
        """
...
[docs]    def is_attacked_by(self, color: Color, square: Square) -> bool:
        """
...
[docs]    def attackers(self, color: Color, square: Square) -> SquareSet:
        """
...
[docs]    def pin(self, color: Color, square: Square) -> SquareSet:
        """
...
[docs]    def is_pinned(self, color: Color, square: Square) -> bool:
        """
...
[docs]    def remove_piece_at(self, square: Square) -> Optional[Piece]:
        """
...
[docs]    def set_piece_at(self, square: Square, piece: Optional[Piece], promoted: bool = False) -> None:
        """
...
[docs]    def board_fen(self, *, promoted: Optional[bool] = False) -> str:
        """
...
[docs]    def set_board_fen(self, fen: str) -> None:
        """
...
[docs]    def piece_map(self, *, mask: Bitboard = BB_ALL) -> Dict[Square, Piece]:
        """
...
[docs]    def set_piece_map(self, pieces: Mapping[Square, Piece]) -> None:
        """
...
[docs]    def set_chess960_pos(self, scharnagl: int) -> None:
        """
...
[docs]    def chess960_pos(self) -> Optional[int]:
        """
...
[docs]    def unicode(self, *, invert_color: bool = False, borders: bool = False, empty_square: str = "⭘") -> str:
        """
...
[docs]    def transform(self: BaseBoardT, f: Callable[[Bitboard], Bitboard]) -> BaseBoardT:
        """
...
[docs]    def mirror(self: BaseBoardT) -> BaseBoardT:
        """
...
[docs]    def copy(self: BaseBoardT) -> BaseBoardT:
...
[docs]    def clear_stack(self) -> None:
        """Clears the move stack."""
        self.move_stack.clear()
        self._stack.clear()


[docs]    def root(self: BoardT) -> BoardT:
...
[docs]    def checkers(self) -> SquareSet:
        """
...
[docs]    def is_variant_end(self) -> bool:
        """
...
[docs]    def is_variant_loss(self) -> bool:
        """
...
[docs]    def is_variant_win(self) -> bool:
        """
...
[docs]    def is_variant_draw(self) -> bool:
        """
...
[docs]    def outcome(self, *, claim_draw: bool = False) -> Optional[Outcome]:
        """
...
[docs]    def is_checkmate(self) -> bool:
...
[docs]    def is_stalemate(self) -> bool:
...
[docs]    def is_insufficient_material(self) -> bool:
        """
...
[docs]    def has_insufficient_material(self, color: Color) -> bool:
        """
...
[docs]    def is_seventyfive_moves(self) -> bool:
        """
...
[docs]    def is_fivefold_repetition(self) -> bool:
        """
        Since the 1st of July 2014 a game is automatically drawn (without
...
[docs]    def can_claim_draw(self) -> bool:
        """
...
[docs]    def is_fifty_moves(self) -> bool:
        """
...
[docs]    def can_claim_fifty_moves(self) -> bool:
        """
...
[docs]    def can_claim_threefold_repetition(self) -> bool:
        """
...
[docs]    def is_repetition(self, count: int = 3) -> bool:
        """
...
[docs]    def push(self: BoardT, move: Move) -> None:
        """
...
[docs]    def find_move(self, from_square: Square, to_square: Square, promotion: Optional[PieceType] = None) -> Move:
        """
...
[docs]    def has_pseudo_legal_en_passant(self) -> bool:
...
[docs]    def has_legal_en_passant(self) -> bool:
        """Checks if there is a legal en passant capture."""
        return self.ep_square is not None and any(self.generate_legal_ep())


[docs]    def fen(self, *, shredder: bool = False, en_passant: _EnPassantSpec = "legal", promoted: Optional[bool] = None) -> str:
        """
...
[docs]    def set_castling_fen(self, castling_fen: str) -> None:
        """
...
[docs]    def chess960_pos(self, *, ignore_turn: bool = False, ignore_castling: bool = False, ignore_counters: bool = True) -> Optional[int]:
        """
...
[docs]    def epd(self, *, shredder: bool = False, en_passant: _EnPassantSpec = "legal", promoted: Optional[bool] = None, **operations: Union[None, str, int, float, Move, Iterable[Move]]) -> str:
        """
...
[docs]    def set_epd(self, epd: str) -> Dict[str, Union[None, str, int, float, Move, List[Move]]]:
        """
...
[docs]    def san(self, move: Move) -> str:
        """
...
[docs]    def lan(self, move: Move) -> str:
        """
...
[docs]    def variation_san(self, variation: Iterable[Move]) -> str:
        """
...
[docs]    def parse_san(self, san: str) -> Move:
        """
...
[docs]    def push_san(self, san: str) -> Move:
        """
...
[docs]    def uci(self, move: Move, *, chess960: Optional[bool] = None) -> str:
        """
...
[docs]    def parse_uci(self, uci: str) -> Move:
        """
...
[docs]    def push_uci(self, uci: str) -> Move:
        """
...
[docs]    def is_en_passant(self, move: Move) -> bool:
...
[docs]    def is_capture(self, move: Move) -> bool:
...
[docs]    def is_zeroing(self, move: Move) -> bool:
...
[docs]    def is_irreversible(self, move: Move) -> bool:
        """
...
[docs]    def is_castling(self, move: Move) -> bool:
...
[docs]    def is_kingside_castling(self, move: Move) -> bool:
        """
...
[docs]    def is_queenside_castling(self, move: Move) -> bool:
        """
...
[docs]    def clean_castling_rights(self) -> Bitboard:
        """
...
[docs]    def has_castling_rights(self, color: Color) -> bool:
        """Checks if the given side has castling rights."""
        backrank = BB_RANK_1 if color == WHITE else BB_RANK_8
        return bool(self.clean_castling_rights() & backrank)


[docs]    def has_kingside_castling_rights(self, color: Color) -> bool:
        """
...
[docs]    def has_queenside_castling_rights(self, color: Color) -> bool:
        """
...
[docs]    def has_chess960_castling_rights(self) -> bool:
        """
...
[docs]    def transform(self: BoardT, f: Callable[[Bitboard], Bitboard]) -> BoardT:
        board = self.copy(stack=False)
        board.apply_transform(f)
        return board
...
[docs]    def mirror(self: BoardT) -> BoardT:
        """
        Returns a mirrored copy of the board.
...
[docs]    def copy(self: BoardT, *, stack: Union[bool, int] = True) -> BoardT:
        """
        Creates a copy of the board.
...
[docs]    def add(self, square: Square) -> None:
        """Adds a square to the set."""
        self.mask |= BB_SQUARES[square]


[docs]    def discard(self, square: Square) -> None:
...
[docs]    def isdisjoint(self, other: IntoSquareSet) -> bool:
        """Tests if the square sets are disjoint."""
        return not bool(self & other)


[docs]    def issubset(self, other: IntoSquareSet) -> bool:
        """Tests if this square set is a subset of another."""
        return not bool(self & ~SquareSet(other))


[docs]    def issuperset(self, other: IntoSquareSet) -> bool:
...
[docs]    def remove(self, square: Square) -> None:
        """
